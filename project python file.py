...
Original file is located at
    https://colab.research.google.com/drive/1poVIF4I7Et83a8X8XSOQbr55QZkG24X2
"""
...
b_bye=['tata','catch you later','see you later','bye','bye bye',
       'adios','cheerio','ciao']
X=[]
X = a_hows + a_whats + a_greets + a_do + a_gl + a_weather + a_game + a_bye + a_population + a_pawned
